...
public:
    ...
    /**
     * Gets the speed factor modifier provided by the accessory.
     * Pure virtual function, must be implemented by derived classes.
     */
    virtual double getSpeedFactor() const = 0;

    /**
     * Gets the detection modifier provided by the accessory.
     * Default implementation returns 1.0 (no modification).
     */
    virtual float getDetectionModifier() const { return 1.0; }

     /**
     * Gets the resistance modifier provided by the accessory.
     * Default implementation returns 1.0 (no modification).
     */
    virtual float getResistanceModifier() const { return 1.0; }

    /**
    * Gets the type of the accessory as a string.
    * Pure virtual function, must be implemented by derived classes.
    */
